...
public class FruitShopServlet extends HttpServlet {
	...
	// 해당 서블릿으로 GET방식 요청이 들어오면 doGet()에서 처리한다
	@Override
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		// form으로 요청보낸 데이터들을 요청 객체의 getParameter()메서드로 꺼낼 수 있다
		// getParameter("name") 메서드로 꺼낼 수 있다 (input태그에서 설정한 name)
		// getParameter("name")는 어떤 데이터를 보내던 간에 일단은 문자열로 꺼내게 된다
	...
	// POST방식 요청은 doPost()에 도착한다
	@Override
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		System.out.println("POST방식 요청입니다~!");
